...
export const blogPosts: BlogPost[] = [
  {
    ...
    likes: 184,
    category: 'place',
    featured_image: '/images/BALADIANG.jpg',
    images: [
      {
        src: '/images/BALADIANG.jpg',
        alt: 'Baladiang family at the shore',
...
As I pack my things to go home, suddenly, the wind breathes through my skin like a hug from the universe reminding me that life isn’t as heavy as it seems, people aren’t as difficult as they come, and wisdom lies in the courage to ask strangers “kumusta?”`,
  ...
  {
    id: '2',
    slug: 'sa-pasilong-sang-pagtuo-kag-paglaum',
    title: 'Sa Pasilong sang Pagtuo kag Paglaum',
    excerpt:
      'A moment of pause and reflection at Binondo Church reveals how sacred spaces hold refuge, faith, and hope across generations.',
    date: '2026-04-26',
    author: 'Sandara Rose M. Labayo',
    likes: 143,
    category: 'spiritual',
    featured_image: '/images/LABAYO.jpg',
    images: [
      {
        src: '/images/LABAYO.jpg',
        alt: 'Binondo Church sanctuary',
...
Under that shelter we all become part of something that continues.`,
    tags: ['faith', 'spiritual', 'reflection', 'binondo', 'hope', 'community'],
  },
  {
    id: '3',
    slug: 'kulor-kang-panubli-on',
    title: 'Kulor kang Panubli-on',
    excerpt:
      'In traditional dance and movement, culture lives on—not as performance, but as a continuation of something alive and breathing.',
    date: '2026-04-26',
    author: 'Vannesa Althea N. Raba',
    likes: 121,
    category: 'tradition',
    featured_image: '/images/RABA.jpg',
    images: [
      {
        src: '/images/RABA.jpg',
        alt: 'Traditional dance in patadyong',
...
Nagapadayon, living on through them, and maybe even through us.`,
  ...
  {
    id: '4',
    slug: 'in-his-hands-the-past-lives-on',
    title: 'In His Hands, the Past Lives On',
    excerpt:
      'A quiet moment between father and daughter reveals how we become guardians of family history, keeping the past alive through memory and love.',
    date: '2026-04-26',
    author: 'Rebeca Jean C. Sobrevega',
    likes: 96,
    category: 'family',
    featured_image: '/images/SOBREVEGA.jpg',
    images: [
      {
        src: '/images/SOBREVEGA.jpg',
        alt: 'Father holding family photograph',
...
As I take this picture, I was showing how my grandmother carried these exact plates, but instead of a clear and translucent plates my grandmother once held when she was a kid, it’s now an amber like stained crystal plates held together in a stack by me, showing off that time truly is a reverie.`,
  ...
  {
    id: '9',
    slug: 'alvarez-family-attic',
    title: 'A Rebel in the family',
    excerpt:
      'In a family home filled with law books and ancestral treasures, one woman chose her own path—guided by light through a camera lens.',
    date: '2026-04-26',
    author: 'Joriel Agustina Marie Alvarez',
    likes: 0,
    category: 'tradition',
    ...
    images: [
      {
        src: '/images/ALVAREZ.jpg',
        alt: 'Family attic with books and heirlooms',
        caption: 'The attic holds generations of stories, decisions, and dreams.',
      },
    ],
    story: `In the quietest corners of our family home, there lies a strange space in the attic that's filled with dust, old pictures, ink, and family heirlooms. To any person, it seems like it's just an ordinary attic—a typical storage room filled with piles of old photo albums and books that have been untouched for decades. Some may say that all the things inside the attic and shelves feel unimportant or unnecessary. No one dares to even enter that place, but only when one finds the time to rummage around out of their curiosity.

Our home will forever be tucked into that kind of service. A kind of service wherein the work is based on legal beliefs, religious practices, and clearer goals. The Alvarez family are known to be smart, both life and academically. Members possess the skills of those who ought to be successful someday, such as teachers, doctors, practitioners, lawyers, business men, and so on.
...
With the use of my camera, I was able to grasp how the world works. My perspective changed, and I began to understand the history. This "Pamana" is a symbol of legacy through broken spines and worn out covers. It is fascinating how wisdom can be passed down like a treasure, and I will always be proud of the knowledge they've shared for me.`,
    tags: ['family', 'heritage', 'legacy', 'personal-journey'],
  },
  {
    id: '10',
    slug: 'mirror-of-memory-pamana-resilience',
    title: 'The Mirror of Memory: Pamana as Resilience',
    excerpt: 'A photograph of ruined grandeur and its glassy reflection that together tell a story of memory and resilience.',
    date: '2026-04-27',
    ...
    images: [
      {
        ...
        alt: 'Ruins reflected in water - BAWI-IN',
  ...
  {
    id: '11',
    slug: 'pag-kinamot-sa-kalipay-kag-pag-kaon',
    title: 'Pag-Kinamot sa Kalipay kag Pag-Kaon',
    excerpt: '',
    date: '2026-04-27',
    author: 'Irene F. Gonzales',
    likes: 0,
    category: 'tradition',
    featured_image: '/images/GONZALES.jpg',
    images: [
      {
        src: '/images/GONZALES.jpg',
        alt: 'Sharing a meal with bare hands',
        caption: 'Pag-kinamot: sharing a meal by hand',
      },
    ],
    story: `There is something beautifully powerful about sharing a meal using bare hands under a simple roof
  where stories are being told, and laughter that feels natural and raw. This photo is one of those simple
  moments, isa ka payak pero puno sang kalipay nga pagtililipon.

  For Filipinos, the hands and banana leaves symbolize something more than just the instruments
  used for eating, rather they are expressions of the beauty and essence of the Filipino culture in its purest
  form. They represent an entire lifestyle, one that is tied to tradition and experiences, which help people
  come together and relish those experiences. Years can pass by, but no one will ever be able to erase them
  from our memory.
  ...
  As a student, work has been piling up, and I rarely have time to breath. But this view really makes
  me realize to slow down and enjoy life. It kind of reminds me back home, where I don't need all the fancy
  things to make me happy, just a simple meal together with my family is already enough. Savoring dish after
  dish while companionship flows like wine means there's no urgency to cross the finish line. Bisan hinde
  madamo ang pagkaon, basta ululupod is the highest form of contentment.

  There is a sense of touch in every action as hands are extended to share food and move it from one person to the other. The shared touch is warm and comforting while eyes connect and smiles are shared without words; this simple interaction creates a connection which is remembered. This scene demonstrates that happiness doesn't always need to be spectacular; it may occasionally be found in simple connections, food, and company where people feel accepted and loved and where there is a common understanding even in solitude.

  This photo makes me overjoyed because it reminds me that happiness doesn’t necessarily come
